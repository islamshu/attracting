            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-colored-form-control"> تعديل الملف الشخصي</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('company.profile.post') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required value="{{ auth()->user()->company_name }}" id="userinput1"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required value="{{ auth()->user()->owner_name }}" id="userinput2"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" value="{{ auth()->user()->phone }}" required id="userinput3"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file"  id="userinput4" value="{{ auth()->user()->commercial_register }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select required class="selectpicker form-control" name="governorate_id" id="governorate_id" data-live-search="true">
                                                ...
                                                <option value="{{ $item->id }}" @if($item->governorate_id == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-6">
