            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-colored-form-control">تعديل خدمة</h4>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="title_ar" value="{{ $service->getTranslation('title','ar')  }}">
                                        </div>
                                        <div class="col-md-6">
                                            <br><label> العنوان بالانجليزي * </label>
                                            <input type="text" class="form-control" name="title_en" value="{{ $service->getTranslation('title','en')  }}">
                                        </div>
                                        <div class="col-md-6">
                                            <br><label> الوصف  بالعربي * </label>
                                            <textarea name="dec_ar" class="ckeditor" cols="30"
                                                rows="10">{{ $service->getTranslation('dec','ar')   }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <br><label> الوصف  بالانجليزي * </label>
                                            <textarea name="dec_en" class="ckeditor" cols="30"
                                                rows="10">{{ $service->getTranslation('dec','en')   }}</textarea>
                                        </div>
