                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('sliders.store') }}"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="main_title_ar" class="ckeditor" cols="30" rows="10">{{ old('main_title_ar') }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <br><label> العنوان الاساسي بالانجليزي * </label>
                                          <textarea name="main_title_en" class="ckeditor" cols="30" rows="10">{{ old('main_title_en') }}</textarea>
                                      </div>
                                        <div class="col-md-6">
                                            <br><label> العنوان  بالعربي * </label>
                                            <textarea name="title_ar" class="ckeditor" cols="30"
                                                rows="10">{{ old('title_ar') }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <br><label> العنوان  بالانجليزي * </label>
                                            <textarea name="title_en" class="ckeditor" cols="30"
                                                rows="10">{{ old('title_en') }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <br><label> عنوان الزر بالعربي </label>
                                            <input type="text" name="text_button_ar" class="form-control" value="{{ old('text_button_ar') }}">
                                        </div>
                                        <div class="col-md-6">
                                            <br><label> عنوان الزر بالانجليزي </label>
                                            <input type="text" name="text_button_en" class="form-control" value="{{ old('text_button_en') }}">
                                        </div>
                                        <div class="col-md-6">
