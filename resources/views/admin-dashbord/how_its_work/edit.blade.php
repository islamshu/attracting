                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('how_its_work.update',$work->id) }}"
                                enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="form-body">
                                    <h4 class="form-section"><i class="la la-add"></i>تعديل خادمة</h4>
                                    <div class="row increment" >
                                        ...
                                        <div class="input-group control-group " >
                                            <input required type="text" name="icon" value="{{ $work->icon }}"  class="form-control">
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <div class="input-group control-group " >
                                            <input required type="text" name="title_ar" value="{{$work->getTranslation('title','ar') }}"  class="form-control">
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          ...
                                          <div class="input-group control-group " >
                                            <input required type="text" name="title_en"  value="{{ $work->getTranslation('title','en') }}"  class="form-control">
                                          </div>
                                        </div>
                                        <div class="col-md-6">
