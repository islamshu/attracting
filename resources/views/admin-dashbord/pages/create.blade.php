            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">اضافة صفحة
                        </li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-colored-form-control">اضافة صفحة</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('pages.store') }}"
                                ...
                                @csrf
                                <div class="form-body">
                                    <h4 class="form-section"><i class="la la-add"></i>إضافة صفحة</h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <br><label> العنوان  بالعربي * </label>
                                            <input required type="text" class="form-control" name="title_ar" value="{{ old('title_ar')  }}">
                                        </div>
                                        <div class="col-md-6">
                                            <br><label> العنوان بالانجليزي * </label>
                                            <input required type="text" class="form-control" name="title_en" value="{{ old('title_en')  }}">
                                        </div>
                                        <div class="col-md-6">
